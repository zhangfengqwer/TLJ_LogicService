...
class NetRespond_UseHuaFei
{
    public static string doAskCilentReq_UseHuaFei(IntPtr connId, string reqData)
    {
        ...
        try
        {
            ...
            // 传给数据库服务器
            {
                ...
                temp.Add("uid", uid);
                temp.Add("prop_id", jo.GetValue("prop_id").ToString());
                temp.Add("phone", jo.GetValue("phone").ToString());
